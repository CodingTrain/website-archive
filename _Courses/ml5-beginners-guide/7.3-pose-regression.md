...
---
This builds on the previous video of using posenet's output as input for our neural network. In this one we use regression instead of classification to output a color.